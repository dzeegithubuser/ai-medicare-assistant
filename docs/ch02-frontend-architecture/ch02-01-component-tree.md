...
App (root) → <router-outlet />
 ...
 └── DashboardComponent (/ — guarded by authGuard)
      ...
      └── Main Split Layout
           ...
           │    │    │    ├── CompareMedicareComponent (Medicare-vs-Medicare, 5-tab shell)
           │    │    │    │    ├── CompareMedicareMetricsComponent (cost + profile KPI cards)
           ...
           │    │    │    ├── CompareLtcComponent (LTC-vs-LTC, 4-tab)
           │    │    │    │    ├── CompareLtcMetricsComponent (cost + profile KPI cards)
           │    │    │    │    └── TabProfileComponent (shared)
           │    │    │    └── CompareCrossComponent (Medicare-vs-LTC, 3-tab)
           │    │    │         ├── CompareCrossMetricsComponent (cross-type KPI cards)
           │    │    │         └── TabProfileComponent (shared)
