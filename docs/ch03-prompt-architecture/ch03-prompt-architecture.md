...
`Application/Services/PageContextBuilder.cs` — internal static helper. Called by `ChatIntentService` immediately before each AI call.
...
← [Chapter 2 — Frontend Architecture](../ch02-frontend-architecture/ch02-frontend-architecture.md) | [Table of Contents](../APPLICATION_BLUEPRINT.md) | [Chapter 4 → Backend Architecture](../ch04-backend-architecture/ch04-backend-architecture.md)
